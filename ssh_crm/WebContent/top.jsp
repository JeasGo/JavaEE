								...
								<TR>
								 ...
								 <c:if test="${empty loginUser }">
								 	<TD height=35 align="right">
										<A href="login.jsp" target=_top><FONT color=red>用户登录</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="login.jsp" target=_top><FONT color=red>管理员登陆</FONT></A>
									</TD> 
								 </c:if>
								  <c:if test="${not empty loginUser }">
								  	<TD height=35 align="right">
											当前用户：${loginUser.user_name }
											&nbsp;&nbsp;&nbsp;&nbsp;
											<A href="#" target=_top><FONT color=red>修改密码</FONT></A>
											&nbsp;&nbsp;&nbsp;&nbsp;
											<A href="${pageContext.request.contextPath}/loginOut.jsp" target=_top><FONT color=red>安全退出</FONT></A>
									</TD>
								  </c:if>
