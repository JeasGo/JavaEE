...
public class MailUtils {
	...
	private static String USERNAME = "18019936556@163.com";//邮箱帐号
	private static String PASSWORD = "525age";//邮箱密码（对于网易邮箱，这里是授权码，不是真正的密码）
	private static String FROM = "768119801@qq.com";//发送的邮箱地址
//	private static String activeUrl = "http://localhost:9003/bos_fore/customer_activeMail";//激活地址

	//发送邮件
	/**
	 * Subject:邮件主题 <br>  	
	 * Content:邮件正文（可以使用html标签）		<br>  
	 * To:收件人（可以增加多个收件人、抄送、密送）	<br>  	
	 * @param Subject:邮件主题
	 * @param Content:邮件正文（可以使用html标签）
	 * @param To:收件人（可以增加多个收件人、抄送、密送）
	 */
