...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer/customer_list.action" method=post>	
										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<s:iterator value="customers" >
													...
													<TD><s:property value="cust_idustry"/></TD>
												...
												<%-- <s:iterator value="customers" var="customer">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer/CustomerServlet?method=editCustomerUI&custId=<s:property value="#customer.custId"/>">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer/CustomerServlet?method=removeCustomer&custId=<s:property value="#customer.custId"/>">删除</a>
													</TD>
												</TR>	
